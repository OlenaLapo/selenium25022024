...
import pytest
from selenium25022024.page_object_pattern.pages.search_hotel import SearchHotelPage
from selenium25022024.page_object_pattern.pages.search_result import SearchResultPage
